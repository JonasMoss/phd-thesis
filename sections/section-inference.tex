...
Since $\{P_{\theta}\},\,\theta\in[0,1]$ has no likelihoods, the Bayesian
...
The Robins--Wasserman does not matter to a Bayesian that firmly knows
...
For a better motivated variant of parameter estimation, we could reframe
...
lack of explicit alternative hypotheses. That \emph{p}-values\emph{
}are usually framed without explicit alternative hypotheses is sometimes
...
against formal alternatives hypotheses and power calculations \parencite{Lehmann1993-oa}.
A compelling argument for why alternative hypotheses are important
is the Albino argument of \cite{Berkson1942-hj}:
\begin{quotation}
